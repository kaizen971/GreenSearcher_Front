...
import { setlastName, setisConnect, setfirstName, setEmail } from '../actions';
import {connexionOn} from '../actions'
import { styles } from './styles';
import IsAuthentify  from '../components/isAuthentify';
...
export default function Feed({ navigation }) {
  ...
  const { isconnect } = useSelector(state => state.ConnexionReducer);
